...
# MFR.r2BEAD.b.sp.select <- merge(MFR.r2BEAD.b.sp.select,
#    data.frame(spName=zymo.bac.g,spName2=zymo.bac),by="spName",all.x=T )
# MFR.r2BEAD.b.sp.select$spName2 <- as.character(MFR.r2BEAD.b.sp.select$spName2)
# MFR.r2BEAD.b.sp.select$spName2[which(is.na(MFR.r2BEAD.b.sp.select$spName2))] <- 
#  as.character(MFR.r2BEAD.b.sp.select$spName[which(is.na(MFR.r2BEAD.b.sp.select$spName2))])
#MFR.r2BEAD.b.sp.select$spName <- as.factor(MFR.r2BEAD.b.sp.select$spName2)
...
MFR.r2BEAD.b.sp.ref.anno$TC <- MFR.r2BEAD.b.sp.ref.anno$TC/100
