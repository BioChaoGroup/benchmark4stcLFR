...
raxml_file <- system.file("extdata/RAxML/",
                          "RAxML_bipartitionSFRanchLabels.H3", 
                          package="treeio")
...
phylum.raxml <- read.raxml2("../../Results/JAN20/SAM/SFR/PREDICT/RAxML_bipartitions.phylum+ref.ssu.raxml")
...
path.info <- read.table("../../Results/JAN20/SAM/SFR/KRAKEN/test/data/added.tsv",
       sep="\t",fill = NA,col.names = c("id","rank","clade","anno","SID"),as.is = T)


phylum.raxml <- read.raxml("../../Results/JAN20/SAM/SFR/PREDICT/RAXML/RAxML_bipartitionSFRanchLabels.phylum+ref.ssu.raxml")
p.info <- read.table("../../Results/JAN20/SAM/SFR/PREDICT/phylum.SSU.inf",sep="\t",fill=NA,
...
test species tree:
```{r}
sp.raxml <- read.raxml2("../../Results/JAN20/SAM/SFR/PREDICT/RAxML_bipartitions.species+ref.ssu.raxml")
sp.info <- read.table("../../Results/JAN20/SAM/SFR/PREDICT/species.SSU.inf",sep="\t",fill = NA,
