...
# 0. 整合注释信息，将其分类至不同水平
```{bash, eval=FALSE}
# /ldfssz1/ST_META/F16HQSB1SY2636_TumorMeta_ZH/fangchao/benchmark4stlfr/Assay/16.DEC20/SAM/SBR/KRAKEN/BEAD+/taxonomy/paths.txt 
...
for (i in unique(nhx_reduced$phylum)){
  ...
  cat(i,":", sprintf("%1.1f%%", 100*dim(a%>%filter(genus=="Unknown__CLADE"))[1] /dim(a)[1]),"(", dim(a%>%filter(genus=="Unknown__CLADE"))[1],"/",dim(a)[1],")","\n")
}
