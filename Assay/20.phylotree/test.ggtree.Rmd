...
metabbq IO tree2fa -s SAM/SBR/CLIP/SSU.barrnap.fa -l SAM/SBR/CLIP/LSU.barrnap.fa -r genus -d CLADE0.97 -t SAM/SBR/KRAKEN/db/data/added.txt -o SAM/SBR/PREDICT/genus.fa -p -v

metabbq IO tree2fa -i SAM/SBR/CLIP/all.SSU.fa -r genus -d CLADE0.97 -t SAM/SBR/KRAKEN/BEAD/data/added.txt -o SAM/SBR/PREDICT/genus.ssu.fa -v
