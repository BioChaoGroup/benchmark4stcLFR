...
SAM=RCA197M0$i\_$j;
echo "blastn -num_threads 4 -query $SAM/summary.BI.megahit.contig.fasta -db $MDB/NCBI/blast_nt/nt -out $SAM/summary.BI.megahit.contig.b6 -outfmt '6 std staxid ssciname' -word_size 7 -evalue 10"
done;done
```
