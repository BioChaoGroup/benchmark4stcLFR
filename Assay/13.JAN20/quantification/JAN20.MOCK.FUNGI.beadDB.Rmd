...
MFR.r2BEAD.species.read.bracken <- read.table(
  md5("../../../Results/JAN20/STAT/KRAKEN/MFR.reads2BEAD.read.bracken","78b7b9a799b1122e15cab6640189dcb5"),
...
MFR.r2BEAD.species.bead.bracken <- read.table(
  md5("../../../Results/JAN20/STAT/KRAKEN/MFR.reads2BEAD.bead.bracken","fa9b67a91669d92db19b8ec7d882a95a"),
  as.is = T,quote = "",comment.char = "", sep="\t",
  col.names = c("SID","name","taxID","rank","kraken_assigned_reads","added_reads","new_est_reads","fraction_total_reads"))

MFR.r2refbead.species.read.bracken <- read.table(
  md5("../../../Results/JAN20/STAT/KRAKEN/MFR.reads2refbead.read.bracken","1ed59b4ac7cd53c8f3fae565ab8e5c1f"),
  as.is = T,quote = "",comment.char = "", sep="\t",
  col.names = c("SID","name","taxID","rank","kraken_assigned_reads","added_reads","new_est_reads","fraction_total_reads"))

MFR.r2refbead.species.bead.bracken <- read.table(
  md5("../../../Results/JAN20/STAT/KRAKEN/MFR.reads2refbead.bead.bracken","49a7153ad792c0d7e0dedc8236bb7af0"),
  as.is = T,quote = "",comment.char = "", sep="\t",
  col.names = c("SID","name","taxID","rank","kraken_assigned_reads","added_reads","new_est_reads","fraction_total_reads"))
