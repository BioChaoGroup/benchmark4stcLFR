...
MBR.r2BEAD.species.read.bracken <- read.table(
  md5("../../../Results/JAN20/STAT/KRAKEN/MBR.reads2BEAD.read.bracken","4c6f603cdc7f61e2c08f9262e59f2576"),
...
MBR.r2BEAD.species.bead.bracken <- read.table(
  md5("../../../Results/JAN20/STAT/KRAKEN/MBR.reads2BEAD.bead.bracken","04dd8e152bf129e4b8af660fa5d8a2dc"),
  as.is = T,quote = "",comment.char = "", sep="\t",
  col.names = c("SID","name","taxID","rank","kraken_assigned_reads","added_reads","new_est_reads","fraction_total_reads"))

MBR.r2refbead.species.read.bracken <- read.table(
  md5("../../../Results/JAN20/STAT/KRAKEN/MBR.reads2refbead.read.bracken","09ce4cfd314136aff19a06292656f767"),
  as.is = T,quote = "",comment.char = "", sep="\t",
  col.names = c("SID","name","taxID","rank","kraken_assigned_reads","added_reads","new_est_reads","fraction_total_reads"))

MBR.r2refbead.species.bead.bracken <- read.table(
  md5("../../../Results/JAN20/STAT/KRAKEN/MBR.reads2refbead.bead.bracken","2496bc4999727b13014c1fd927f182f5"),
  as.is = T,quote = "",comment.char = "", sep="\t",
  col.names = c("SID","name","taxID","rank","kraken_assigned_reads","added_reads","new_est_reads","fraction_total_reads"))
