...
basic.ORI.tsv <- read.table("../../Results/JAN20/STAT/ORI.basic.log",header = T)
basic.SAM.S.tsv <- read.table("../../Results/JAN20/STAT/SAM.basic.single.log",header = T)
basic.SAM.R.tsv <- read.table("../../Results/JAN20/STAT/SAM.basic.RCA.log",header = T)
basic.SAM.N.tsv <- read.table("../../Results/JAN20/STAT/SAM.basic.NOR.log",header = T)

ORI.BB.stat <- read.table("../../Results/JAN20/STAT/ORI.BB.stat",
                         col.names = c("tag","count","rpb","cumsum"))
BB.stat <- ORI.BB.stat
SAM.BB.stat <- read.table("../../Results/JAN20/STAT/SAM.BB.stat",
                         col.names = c("tag","count","rpb","cumsum"))
BI.msh.tsv <- read.table("../../Results/JAN20/STAT/BI.msh.tsv",
...
ggplot(basic.ori.df3,aes(x=lane,y=val)) + geom_boxplot() + coord_flip() +
